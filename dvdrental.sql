-- 1.Construye las siguientes consultas: 
-- Aquellas usadas para insertar, modificar y eliminar un Customer, Staff y Actor. 

INSERT INTO public.actor
(first_name, last_name, last_update)
VALUES('Adrian', 'Roman', now());

DELETE FROM public.customer
WHERE customer_id=nextval('customer_customer_id_seq'::regclass);

UPDATE public.staff
SET first_name='Andres', last_name='Ramazotti', email='aramazotti@gmail.com', username='aramazotti', "password"='1357', last_update=now()
WHERE staff_id=7;
...
WHERE EXTRACT(YEAR FROM rental.rental_date) = 2004
